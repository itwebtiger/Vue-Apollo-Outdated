    ...
    <nav class="navbar">
      <div class="navbar-brand">
        <a class="navbar-item headerTitle" @click="goFeed">
          <h1 class="is-1 is-white">Outside</h1>
        </a>
          ...
          <div class="navbar-item">
            <div class="field is-grouped">
              ...
              <div class="control">
                ...
                <img :src="userInfo.avatar" v-if="authenticated&&userInfo.avatar" @click="goSetting" />
                <div @click="goSetting">
                  <v-gravatar hash="f3ada405ce890b6f8204094deb12d8a8" alt="Nobody" :size="200" default-img="retro" v-if="authenticated&&!userInfo.avatar" />
                </div>
              </div>
            </div>
          </div>

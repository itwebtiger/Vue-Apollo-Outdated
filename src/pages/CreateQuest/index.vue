      ...
      <div class="column is-6 is-offset-3">
        <div class="suggest">
          <div class="content column is-8 is-offset-2">
            ...
            <p class="comment">
              Use this form to suggest a quest idea! It must pass our <span @click="showRuleModal">rigourous test</span> in order to be permitted on the site. You can view the status of your quest suggestion in the <span @click="showQueueModal">moderator queue</span>.
            </p>
            <form @submit="handleSubmit">
              ...
              <div v-for="(row, index) in rows" :key="index">
                <b-field v-bind:label="`Objective # ${index + 1}`" class="field">
                  <b-input
                    required
                    v-model="row.title">
                  </b-input>
              ...
              <div class="btn">
                <button class="button addObjectBtn" @click="addRow">[ Add another objective ]</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // deleteRow(event) {  // Todo: delete button function need to implement
